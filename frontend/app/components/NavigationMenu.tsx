...
function AISystemsDropdown({ currentPath }: { currentPath: string }) {
  ...
  const isActive = ["/ai", "/ai-orchestrator", "/ai-systems", "/round-table", "/oasis-game", "/zion-os", "/ai-chat", "/zion-rig", "/zion-craft"].some(p => currentPath === p || currentPath.startsWith(p + "/"));
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-medium hidden md:inline">AI Orchestrator</span>
        <motion.span
      ...
      >
        <Link href="/ai" className="block">
          <div className={`px-4 py-3 text-sm flex items-center gap-3 hover:bg-white/10 ${currentPath.startsWith('/ai') ? 'text-white' : 'text-gray-300'}`}>
            <span>�</span>
            <div>
              <div className="font-medium">AI Orchestrator</div>
              <div className="text-xs text-gray-400">13 AI Systems + Round Table</div>
            </div>
          </div>
        </Link>
        <div className="h-px bg-white/10" />
        <Link href="/round-table" className="block">
          <div className={`px-4 py-3 text-sm flex items-center gap-3 hover:bg-white/10 ${currentPath.startsWith('/round-table') ? 'text-white' : 'text-gray-300'}`}>
            <span>⚔️</span>
            <div>
              <div className="font-medium">Round Table Council</div>
              <div className="text-xs text-gray-400">12 Knights of AI Wisdom</div>
            </div>
          </div>
        </Link>
        <div className="h-px bg-white/10" />
